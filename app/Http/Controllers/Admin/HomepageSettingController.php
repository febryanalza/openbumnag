...
class HomepageSettingController extends Controller
{
    ...
    protected array $sections = [
        ...
        'about-page' => [
            ...
            'settings' => [
                'about_page_title' => ['label' => 'Judul Halaman', 'type' => 'text', 'placeholder' => 'Tentang Kami'],
                'about_page_subtitle' => ['label' => 'Sub Judul', 'type' => 'text', 'placeholder' => 'Mengenal BUMNag Lubas Mandiri'],
                'about_page_description' => ['label' => 'Deskripsi Utama', 'type' => 'textarea', 'placeholder' => 'BUMNag Lubas Mandiri adalah...'],
                'about_vision_title' => ['label' => 'Judul Visi', 'type' => 'text', 'placeholder' => 'Visi Kami'],
                'about_vision_content' => ['label' => 'Isi Visi', 'type' => 'textarea', 'placeholder' => 'Menjadi BUMNag terdepan...'],
                'about_mission_title' => ['label' => 'Judul Misi', 'type' => 'text', 'placeholder' => 'Misi Kami'],
                'about_mission_content' => ['label' => 'Isi Misi', 'type' => 'textarea', 'placeholder' => '1. Meningkatkan kesejahteraan...'],
                'about_values_title' => ['label' => 'Judul Nilai-Nilai', 'type' => 'text', 'placeholder' => 'Nilai-Nilai Kami'],
                'about_values_content' => ['label' => 'Isi Nilai-Nilai', 'type' => 'textarea', 'placeholder' => 'Integritas, Transparansi...'],
                'about_team_title' => ['label' => 'Judul Tim Pengembang', 'type' => 'text', 'placeholder' => 'Tim Pengembang Website'],
                'about_team_description' => ['label' => 'Deskripsi Tim', 'type' => 'textarea', 'placeholder' => 'Website ini dikembangkan oleh...'],
                'about_team_logo_1' => ['label' => 'Logo Tim 1 (KKN UNP)', 'type' => 'image', 'placeholder' => ''],
                'about_team_name_1' => ['label' => 'Nama Tim 1', 'type' => 'text', 'placeholder' => 'KKN UNP'],
                'about_team_logo_2' => ['label' => 'Logo Tim 2 (BUMNag Lubas)', 'type' => 'image', 'placeholder' => ''],
                'about_team_name_2' => ['label' => 'Nama Tim 2', 'type' => 'text', 'placeholder' => 'BUMNag Lubas Mandiri'],
                'about_team_logo_3' => ['label' => 'Logo Tim 3 (Nagari)', 'type' => 'image', 'placeholder' => ''],
                'about_team_name_3' => ['label' => 'Nama Tim 3', 'type' => 'text', 'placeholder' => 'Nagari Lubuk Basung'],
                'about_team_logo_4' => ['label' => 'Logo Tim 4 (Kabupaten)', 'type' => 'image', 'placeholder' => ''],
                'about_team_name_4' => ['label' => 'Nama Tim 4', 'type' => 'text', 'placeholder' => 'Kabupaten Agam'],
            ],
        ],
        'general' => [
