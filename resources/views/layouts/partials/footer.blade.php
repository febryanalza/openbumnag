        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold">Lubas Mandiri</h3>
                        <p class="text-sm text-mint-200">BUMNag Desa Lubas</p>
                    </div>
                </div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-sm text-mint-200">
                            Desa Lubas, Kecamatan Lubuk Alung, Kabupaten Padang Pariaman
                        </span>
                    </li>
                    <li class="flex items-center space-x-3">
                        ...
                        <span class="text-sm text-mint-200">info@lubasmandiri.id</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        <svg class="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span class="text-sm text-mint-200">+62 812-3456-7890</span>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <a href="#" class="w-10 h-10 bg-sage-700 rounded-full flex items-center justify-center hover:bg-primary transition-colors duration-200">
        ...
        <div class="border-t border-sage-700 mt-8 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-sm text-mint-200">
                    &copy; {{ date('Y') }} Lubas Mandiri. All rights reserved.
                </p>
