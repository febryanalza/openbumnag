    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="px-4 pt-2 pb-3 space-y-1">
            ...
            <a href="https://wa.me/{{ $globalSettings['contact_whatsapp'] ?? '6281234567890' }}" 
               target="_blank"
               rel="noopener noreferrer"
               class="flex items-center justify-center gap-2 px-4 py-3 mt-2 bg-primary text-white text-center font-medium rounded-lg hover:bg-primary-600 transition-colors duration-200">
