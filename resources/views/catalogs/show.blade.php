...
@section('content')
<!-- Breadcrumb -->
<nav class="bg-gray-50 py-4 mt-20 border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ol class="flex items-center space-x-2 text-sm">
            ...
            <li class="text-gray-400">/</li>
            <li class="text-gray-900 font-medium">{{ $catalog->name }}</li>
        </ol>
    </div>
</nav>
...
<section class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
                <!-- Main Image -->
                <div class="mb-4 rounded-2xl overflow-hidden bg-gray-100" x-data="{ currentImage: '{{ $catalog->featured_image ? Storage::url($catalog->featured_image) : '' }}' }">
            ...
            <div>
                ...
                <a href="{{ route('catalogs.index', ['unit_usaha' => $catalog->bumnagProfile->id]) }}" 
                   class="inline-block px-4 py-2 bg-primary/10 text-primary text-sm font-semibold rounded-full hover:bg-primary/20 transition-colors mb-4">
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    @endif
                    @if($catalog->sku)
                    <span class="text-gray-600 text-sm">SKU: {{ $catalog->sku }}</span>
                    @endif
                </div>
                
                <!-- Price -->
                <div class="mb-6 p-6 bg-gradient-to-br from-primary/5 to-sage/5 rounded-xl">
                ...
                <div class="mb-8">
                    ...
                    <dl class="grid grid-cols-1 gap-3">
                        ...
                        <div class="flex border-b border-gray-200 pb-2">
                            <dt class="font-semibold text-gray-700 w-1/3">{{ $key }}</dt>
                ...
                <div class="space-y-3">
                    <a href="https://wa.me/{{ $globalSettings['contact_whatsapp'] ?? '62812345678' }}?text=Halo, saya tertarik dengan {{ $catalog->name }}" 
                       target="_blank"
                       class="w-full flex items-center justify-center gap-2 px-6 py-4 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-colors duration-200">
                    ...
                    <a href="tel:{{ $globalSettings['contact_phone'] }}" 
                       class="w-full flex items-center justify-center gap-2 px-6 py-4 bg-primary text-white font-semibold rounded-xl hover:bg-primary-600 transition-colors duration-200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-1">
                <a href="{{ route('catalogs.show', $product->slug) }}">
                    ...
                    @else
                    <div class="h-48 bg-gradient-to-br from-mint-100 to-sage-100 flex items-center justify-center">
