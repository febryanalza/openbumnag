...
<div class="max-w-5xl mx-auto">
    ...
    <form method="POST" action="{{ route('admin.news.update', $news) }}" enctype="multipart/form-data" class="space-y-6" id="newsForm">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div id="slugDisplay" class="flex-1 px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-600 text-sm">
                            <span id="slugText">{{ $news->slug }}</span>
                        </div>
                    </div>
                    <p class="mt-1 text-sm text-gray-500">Slug akan diperbarui otomatis jika judul berubah</p>
                </div>
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500">{{ old('excerpt', $news->excerpt) }}</textarea>
                </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500">{{ old('meta_description', $news->meta_description) }}</textarea>
                </div>
...
<script>
    ...
    function generateSlug(title) {
        ...
        document.getElementById('slugText').textContent = slug || '{{ $news->slug }}';
        document.getElementById('slug').value = slug || '{{ $news->slug }}';
    }
