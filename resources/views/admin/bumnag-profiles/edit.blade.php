            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-gray-500 text-sm">/bumnag/</span>
                        <div class="flex-1 px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-600 text-sm">
                            <span id="slugDisplay">{{ old('slug', $bumnagProfile->slug) }}</span>
                        </div>
                    </div>
                    <input type="hidden" name="slug" id="slug" value="{{ old('slug', $bumnagProfile->slug) }}">
                </div>
